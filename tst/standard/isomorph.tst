...
true
gap> not DIGRAPHS_NautyAvailable or HasNautyCanonicalLabelling(gr2) and
> NautyCanonicalLabelling(gr2) <> fail;
false
gap> IsomorphismDigraphs(gr1, gr2);;
...
gap> nauty := (ApplicableMethod(AutomorphismGroup, [Digraph([])]) =
